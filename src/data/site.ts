...
export const homeFaqs: readonly FaqItem[] = [
	faq({
		...
		answer:
			'{brand} is an undetected {primaryKeyword} package for Rust on Windows PC. It includes ESP wallhack, 2D radar, and aimbot controls, with {antiCheat} maintenance and setup support.',
		slug: 'what-are-rust-cheats',
	...
	faq({
		...
		answer:
			'{brand} is maintained for {game} with rebuilds after {antiCheat} and game patches. Check the Status page before you raid. No cheat can guarantee permanent undetected status — maintenance and responsible use matter.',
		slug: 'are-rust-cheats-undetected-in-2026',
	...
	faq({
		question: 'Does this work in base raids and PvP fights?',
		answer:
	...
	faq({
		question: 'Where do I check updates after a Rust or {antiCheat} patch?',
		answer:
			'Maintenance notes are posted on the Status page when a Rust or {antiCheat} update affects the package. That is the fastest place to confirm whether a new {brand} build is live.',
...
export const seoFaqs: readonly FaqItem[] = [
	...
	faq({
		...
		answer:
			'A {game} wallhack is an ESP overlay that shows players, NPCs, and loot through walls. {brand} includes distance readouts, raid cues, and toggleable categories.',
		slug: 'what-is-a-rust-wallhack',
	...
	faq({
		...
		slug: 'does-rust-cheats-include-radar-hack',
	...
	faq({
		...
		slug: 'eac-anti-cheat-and-rust-cheats',
	...
	faq({
		...
		slug: 'buy-undetected-rust-cheats-windows-pc',
...
export const customerReviews = [
	reviewMeta({
		handle: 'xKrypt0_Rust',
		rating: 5,
		text: 'Soft aim in Rust Cheats feels smooth on Outpost. The menu took a few minutes to learn. After that, raids felt easy.',
		short: 'Soft aim in Rust Cheats feels smooth on Outpost.',
		slug: 'rust-soft-aim-review-xkrypt0',
		seoTitle: 'Soft Aim Review by @xKrypt0_Rust — 5/5 | {brand}',
		seoDescription: '@xKrypt0_Rust rates {brand} soft aim 5/5 for Outpost on Windows PC.',
		date: '2026-07-24',
		tag: 'Soft aim',
	}),
	reviewMeta({
	...
	reviewMeta({
		handle: 'dma_wizard',
		rating: 5,
		text: 'I moved to Rust Cheats this patch cycle. Setup was simple. It stayed up after the last Easy Anti-Cheat update when my old cheat failed. Lifetime was a good buy.',
		short: 'Rust Cheats stayed up after the last Easy Anti-Cheat update. Lifetime was a good buy.',
	...
	reviewMeta({
		...
		rating: 4,
		text: 'Soft aim in Rust Cheats is easy to tune on PC. I changed FOV a little and it felt natural. Menu is clear enough.',
		short: 'Soft aim in Rust Cheats is easy to tune on PC.',
		slug: 'rust-soft-aim-review-ctrl-player99',
	...
	reviewMeta({
		...
		rating: 3,
		text: 'Rust Cheats works well once it is running. First launch was slow because Windows Defender flagged the loader. Support replied in about two hours. ESP on monuments is solid.',
		short: 'ESP on monuments is solid. Support helped after a slow first launch.',
		slug: 'rust-cheat-setup-review-stormchaser07',
		seoTitle: 'Setup Review by @stormChaser_07 — 3/5 | {brand}',
		seoDescription: '@stormChaser_07 rates {brand} setup 3/5. ESP on monuments is solid after support help.',
		date: '2026-06-15',
		tag: 'Setup',
	}),
	reviewMeta({
		handle: 'lootGoblinx',
		rating: 5,
		text: 'Loot ESP in Rust Cheats pays for the monthly plan. Base markers and distance make early raids faster.',
		short: 'Loot ESP in Rust Cheats pays for the monthly plan.',
	...
	reviewMeta({
		...
		rating: 4,
		text: 'I have used Rust Cheats since last wipe. Soft aim per weapon helps in compound zones. Status updates after Easy Anti-Cheat patches could be clearer, but it came back the next day.',
		short: 'Soft aim per weapon in Rust Cheats helps in compound zones.',
		slug: 'rust-soft-aim-session-review-rankedgrind42',
	...
	reviewMeta({
		handle: 'vanLifeRust',
		rating: 5,
		text: 'Radar in Rust Cheats saved me near monuments and compounds. Seeing the third player early in pairs is huge. Boxes plus radar look clean.',
		short: 'Radar in Rust Cheats saved me near monuments and compounds.',
		slug: 'rust-radar-hack-review-vanliferust',
		seoTitle: 'Radar Review by @vanLifeRust — 5/5 | {brand}',
		seoDescription: '@vanLifeRust rates {brand} radar 5/5 near monuments and compounds on Windows PC.',
		date: '2026-07-28',
		tag: 'Bases',
	}),
	reviewMeta({
		handle: 'patchDayMike',
		rating: 4,
		text: 'Most cheats go down on patch day. Rust Cheats posted on the status page within a few hours and was back the next morning. My old tool left me waiting for days.',
		short: 'Rust Cheats was back the next morning after a patch.',
	...
	reviewMeta({
		handle: 'snipezOnly_',
		rating: 5,
		text: 'Bolt-action soft aim plus ESP in Rust Cheats is excellent for long shots. Simple and strong.',
		short: 'Bolt-action soft aim plus ESP in Rust Cheats is excellent.',
