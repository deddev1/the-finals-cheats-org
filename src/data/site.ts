...
export const seoLandingPages = [
	...
	{ label: fillBrandTokens('{game} hacks'), href: '/finals-cheats/' },
	{ label: fillBrandTokens('{game} cheats 2026'), href: '/finals-cheats-2026/' },
	...
	{ label: fillBrandTokens('Best {primaryKeyword}'), href: '/best-finals-cheats/' },
	{ label: fillBrandTokens('{game} mod menu'), href: '/finals-mod-menu/' },
	{ label: fillBrandTokens('{game} cheat download'), href: '/finals-cheat-download/' },
...
export const mainNav = [
	{ label: 'Home', href: '/' },
	{ label: 'Cheats', href: '/finals-cheats/' },
...
export const footerExplore = [
	...
	{ label: fillBrandTokens('{game} hacks pillar'), href: '/finals-cheats/' },
...
export const homeFaqs: readonly FaqItem[] = [
	faq({
		...
		answer:
			'{brand} is an undetected {primaryKeyword} package for The Finals on Windows PC. It includes ESP wallhack, 2D radar, and aimbot controls, with {antiCheat} maintenance and setup support.',
		slug: 'what-are-finals-cheats',
	...
	faq({
		...
		slug: 'are-finals-cheats-undetected-in-2026',
	...
	faq({
		question: 'Does this work in cashout rounds and arena PvP fights?',
		answer:
			'Yes. ESP, radar, and aimbot are built for {game} match flow — reading players and NPCs, spotting loot, and staying aware near arenas and cashout vaults.',
		slug: 'solo-farmer-and-raider-sessions',
		seoTitle: 'Raid Session and PvP Support | FAQ',
		seoDescription:
			'{brand} works in cashout rounds and arena PvP fights — ESP, radar, and aimbot for Windows PC.',
	}),
	faq({
		question: 'What is included — ESP, wallhack, radar, or Aimbot?',
		answer:
			'{brand} bundles ESP wallhack, vault markers, 2D radar cues, and configurable Aimbot in one license. See Features for the full list.',
		slug: 'esp-wallhack-radar-or-aimbot',
		seoTitle: 'What Is Included: ESP, Wallhack, Radar, Aimbot | FAQ',
		seoDescription:
			'One {brand} license includes ESP wallhack, vault markers, 2D radar cues, and configurable Aimbot for Windows PC.',
	}),
	faq({
	...
	faq({
		question: 'Where do I check updates after a The Finals or {antiCheat} patch?',
		answer:
			'Maintenance notes are posted on the Status page when a The Finals or {antiCheat} update affects the package. That is the fastest place to confirm whether a new {brand} build is live.',
...
export const seoFaqs: readonly FaqItem[] = [
	...
	faq({
		...
		answer:
			'A {game} wallhack is an ESP overlay that shows players, NPCs, and loot through walls. {brand} includes distance readouts, match cues, and toggleable categories.',
		slug: 'what-is-a-finals-wallhack',
		seoTitle: 'What Is a {game} Wallhack? | FAQ',
		seoDescription:
			'A {game} wallhack is ESP that reveals players, NPCs, and loot through walls — with distance, bases, and category toggles.',
	}),
	faq({
		question: 'Does {brand} include a radar hack?',
		answer:
			'Yes. {brand} includes 2D radar overlays that highlight nearby threats outside your view — useful for flanks and cashout zones.',
		slug: 'does-finals-cheats-include-radar-hack',
	...
	faq({
		...
		slug: 'eac-anti-cheat-and-finals-cheats',
	...
	faq({
		...
		slug: 'buy-undetected-finals-cheats-windows-pc',
...
export const customerReviews = [
	reviewMeta({
		handle: 'xKrypt0_Finals',
		rating: 5,
		text: 'Soft aim in The Final Cheats feels smooth on Arena. The menu took a few minutes to learn. After that, matches felt easy.',
		short: 'Soft aim in The Final Cheats feels smooth on Arena.',
		slug: 'finals-soft-aim-review-xkrypt0',
		seoTitle: 'Soft Aim Review by @xKrypt0_Finals — 5/5 | {brand}',
		seoDescription: '@xKrypt0_Finals rates {brand} soft aim 5/5 for Arena on Windows PC.',
		date: '2026-07-24',
		tag: 'Soft aim',
	}),
	reviewMeta({
		handle: 'buildsR4K',
		rating: 4,
		text: 'ESP boxes help on loot runs. You can see who is stalking a monument edge before you push. Still worth the price for The Final Cheats.',
		short: 'ESP boxes help on loot runs. Still worth the price for The Final Cheats.',
		slug: 'finals-esp-growth-run-review-buildsr4k',
	...
	reviewMeta({
		handle: 'dma_wizard',
		rating: 5,
		text: 'I moved to The Final Cheats this patch cycle. Setup was simple. It stayed up after the last Easy Anti-Cheat update when my old cheat failed. Lifetime was a good buy.',
		short: 'The Final Cheats stayed up after the last Easy Anti-Cheat update. Lifetime was a good buy.',
	...
	reviewMeta({
		...
		rating: 4,
		text: 'Soft aim in The Final Cheats is easy to tune on PC. I changed FOV a little and it felt natural. Menu is clear enough.',
		short: 'Soft aim in The Final Cheats is easy to tune on PC.',
	...
	reviewMeta({
		...
		rating: 3,
		text: 'The Final Cheats works well once it is running. First launch was slow because Windows Defender flagged the loader. Support replied in about two hours. ESP in stadiums is solid.',
		short: 'ESP in stadiums is solid. Support helped after a slow first launch.',
		slug: 'finals-cheat-setup-review-stormchaser07',
		seoTitle: 'Setup Review by @stormChaser_07 — 3/5 | {brand}',
		seoDescription: '@stormChaser_07 rates {brand} setup 3/5. ESP in stadiums is solid after support help.',
		date: '2026-06-15',
		tag: 'Setup',
	}),
	reviewMeta({
		handle: 'lootGoblinx',
		rating: 5,
		text: 'Loot ESP in The Final Cheats pays for the monthly plan. Base markers and distance make early matches faster.',
		short: 'Loot ESP in The Final Cheats pays for the monthly plan.',
		slug: 'finals-vault-esp-review-lootgoblinx',
		seoTitle: 'Loot ESP Review by @lootGoblinx — 5/5 | {brand}',
		seoDescription: '@lootGoblinx rates {brand} vault ESP 5/5 for early matches on Windows PC.',
		date: '2026-08-01',
	}),
	reviewMeta({
		handle: 'rankedGrind42',
		rating: 4,
		text: 'I have used The Final Cheats since last patch. Soft aim per weapon helps in cashout zones. Status updates after Easy Anti-Cheat patches could be clearer, but it came back the next day.',
		short: 'Soft aim per weapon in The Final Cheats helps in cashout zones.',
		slug: 'finals-soft-aim-session-review-rankedgrind42',
	...
	reviewMeta({
		handle: 'patchDayMike',
		rating: 4,
		text: 'Most cheats go down on patch day. The Final Cheats posted on the status page within a few hours and was back the next morning. My old tool left me waiting for days.',
		short: 'The Final Cheats was back the next morning after a patch.',
	...
	reviewMeta({
		handle: 'snipezOnly_',
		rating: 5,
		text: 'Long-range soft aim plus ESP in The Final Cheats is excellent for long shots. Simple and strong.',
		short: 'Long-range soft aim plus ESP in The Final Cheats is excellent.',
