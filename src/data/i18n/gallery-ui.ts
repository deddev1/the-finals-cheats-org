...
export const galleryUi: Record<LocaleCode, GalleryUi> = {
	...
	es: {
		...
		highlights: [
			{ title: 'ESP de players y escuadrones', copy: 'Detecta players enemigos y contornos de escuadrón en Outpost y farming run para elegir peleas con mejor información.' },
	...
	fr: {
		...
		highlights: [
			{ title: 'ESP players & escouades', copy: 'Repérez les players ennemis sur Outpost et farming run pour choisir vos engagements.' },
	...
	de: {
		...
		lead: 'Rust Cheats passt zur Raid-Schleife von Rust: Karte lesen, Gegner-Trupps tracken, jagen und Nester überleben.',
		highlights: [
			{ title: 'Player- & Squad-ESP', copy: 'Erkenne feindliche Playeren auf Outpost und farming run für bessere Rotationsentscheidungen.' },
	...
	pt: {
		...
		highlights: [
			{ title: 'ESP de players e epackrões', copy: 'Detecte players inimigos em Outpost e farming run para escolher lutas com melhor intel.' },
	...
	it: {
		...
		highlights: [
			{ title: 'ESP playeri e packre', copy: 'Individua playeri nemici su Outpost e farming run per scegliere i fight con più intel.' },
	...
	nl: {
		...
		highlights: [
			{ title: 'Player- & pack-ESP', copy: 'Spot vijandelijke players op Outpost en farming run voor betere rotatiebeslissingen.' },
	...
	pl: {
		...
		highlights: [
			{ title: 'ESP players i drużyn', copy: 'Wykrywaj wrogich players na Outpost i farming run dla lepszych decyzji rotacyjnych.' },
	...
	ru: {
		...
		highlights: [
			{ title: 'ESP игроков и отрядов', copy: 'Замечайте вражеских игроков на Outpost и farming run для лучших решений по ротации.' },
	...
	tr: {
		...
		highlights: [
			{ title: 'Player ve takım ESP', copy: 'Outpost ve farming run\'da düşman playerleri görerek daha iyi rotasyon kararları alın.' },
	...
	ar: {
		...
		highlights: [
			{ title: 'ESP للمشغلين والفرق', copy: 'اكتشف players المعادين على Outpost وfarming run لاختيار القتالات بذكاء.' },
	...
	ja: {
		...
		highlights: [
			{ title: 'players＆スクワッドESP', copy: 'Outpostとfarming runで敵playersを把握し、ローテ判断を改善。' },
	...
	ko: {
		...
		highlights: [
			{ title: 'players & 스쿼드 ESP', copy: 'Outpost와 farming run에서 적 players를 파악해 로테이션 결정을 개선.' },
	...
	zh: {
		...
		highlights: [
			{ title: 'players与小队 ESP', copy: '在 Outpost 和 farming run 发现敌方players，做出更好的转点决策。' },
	...
	hi: {
		...
		highlights: [
			{ title: 'Player & Squad ESP', copy: 'Outpost और farming run पर enemy players spot करें बेहतर rotation decisions के लिए।' },
	...
	id: {
		...
		highlights: [
			{ title: 'ESP player & pack', copy: 'Deteksi player musuh di Outpost dan farming run untuk keputusan rotasi lebih baik.' },
	...
	th: {
		...
		highlights: [
			{ title: 'ESP ผู้เล่นและทีม', copy: 'มองเห็นศัตรูบน Outpost และ farming run เพื่อตัดสินใจหมุนเวียนได้ดีขึ้น' },
	...
	vi: {
		...
		highlights: [
			{ title: 'ESP player & pack', copy: 'Phát hiện player địch trên Outpost và farming run để quyết định rotate tốt hơn.' },
	...
	uk: {
		...
		highlights: [
			{ title: 'ESP гравців і загонів', copy: 'Помічайте ворожих гравців на Outpost і farming run для кращих ротацій.' },
	...
	cs: {
		...
		highlights: [
			{ title: 'ESP players a packů', copy: 'Spozorujte nepřátelské operátory na Outpost a farming run pro lepší rotační rozhodnutí.' },
	...
	ro: {
		...
		highlights: [
			{ title: 'ESP playeri și pack-uri', copy: 'Detectează playeri inamici pe Outpost și farming run pentru decizii de rotație mai bune.' },
	...
	sv: {
		...
		highlights: [
			{ title: 'Player- & pack-ESP', copy: 'Spotta fiendeplayerer på Outpost och farming run för bättre rotationsbeslut.' },
