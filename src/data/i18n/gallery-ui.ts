...
export const galleryUi: Record<LocaleCode, GalleryUi> = {
	...
	es: {
		...
		highlights: [
			{ title: 'ESP de players y escuadrones', copy: 'Detecta players enemigos y contornos de escuadrón en Arena y cashout route para elegir peleas con mejor información.' },
	...
	fr: {
		...
		highlights: [
			{ title: 'ESP players & escouades', copy: 'Repérez les players ennemis sur Arena et cashout route pour choisir vos engagements.' },
	...
	de: {
		...
		highlights: [
			{ title: 'Player- & Squad-ESP', copy: 'Erkenne feindliche Playeren auf Arena und cashout route für bessere Rotationsentscheidungen.' },
	...
	pt: {
		...
		highlights: [
			{ title: 'ESP de players e epackrões', copy: 'Detecte players inimigos em Arena e cashout route para escolher lutas com melhor intel.' },
	...
	it: {
		...
		highlights: [
			{ title: 'ESP playeri e packre', copy: 'Individua playeri nemici su Arena e cashout route per scegliere i fight con più intel.' },
	...
	nl: {
		...
		highlights: [
			{ title: 'Player- & pack-ESP', copy: 'Spot vijandelijke players op Arena en cashout route voor betere rotatiebeslissingen.' },
	...
	pl: {
		...
		highlights: [
			{ title: 'ESP players i drużyn', copy: 'Wykrywaj wrogich players na Arena i cashout route dla lepszych decyzji rotacyjnych.' },
	...
	ru: {
		...
		highlights: [
			{ title: 'ESP игроков и отрядов', copy: 'Замечайте вражеских игроков на Arena и cashout route для лучших решений по ротации.' },
	...
	tr: {
		...
		highlights: [
			{ title: 'Player ve takım ESP', copy: 'Arena ve cashout route\'da düşman playerleri görerek daha iyi rotasyon kararları alın.' },
	...
	ar: {
		...
		highlights: [
			{ title: 'ESP للمشغلين والفرق', copy: 'اكتشف players المعادين على Arena وcashout route لاختيار القتالات بذكاء.' },
	...
	ja: {
		...
		highlights: [
			{ title: 'players＆スクワッドESP', copy: 'Arenaとcashout routeで敵playersを把握し、ローテ判断を改善。' },
	...
	ko: {
		...
		highlights: [
			{ title: 'players & 스쿼드 ESP', copy: 'Arena와 cashout route에서 적 players를 파악해 로테이션 결정을 개선.' },
	...
	zh: {
		...
		highlights: [
			{ title: 'players与小队 ESP', copy: '在 Arena 和 cashout route 发现敌方players，做出更好的转点决策。' },
	...
	hi: {
		...
		highlights: [
			{ title: 'Player & Squad ESP', copy: 'Arena और cashout route पर enemy players spot करें बेहतर rotation decisions के लिए।' },
	...
	id: {
		...
		highlights: [
			{ title: 'ESP player & pack', copy: 'Deteksi player musuh di Arena dan cashout route untuk keputusan rotasi lebih baik.' },
	...
	th: {
		...
		highlights: [
			{ title: 'ESP ผู้เล่นและทีม', copy: 'มองเห็นศัตรูบน Arena และ cashout route เพื่อตัดสินใจหมุนเวียนได้ดีขึ้น' },
	...
	vi: {
		...
		highlights: [
			{ title: 'ESP player & pack', copy: 'Phát hiện player địch trên Arena và cashout route để quyết định rotate tốt hơn.' },
	...
	uk: {
		...
		highlights: [
			{ title: 'ESP гравців і загонів', copy: 'Помічайте ворожих гравців на Arena і cashout route для кращих ротацій.' },
	...
	cs: {
		...
		highlights: [
			{ title: 'ESP players a packů', copy: 'Spozorujte nepřátelské operátory na Arena a cashout route pro lepší rotační rozhodnutí.' },
	...
	ro: {
		...
		highlights: [
			{ title: 'ESP playeri și pack-uri', copy: 'Detectează playeri inamici pe Arena și cashout route pentru decizii de rotație mai bune.' },
	...
	sv: {
		...
		highlights: [
			{ title: 'Player- & pack-ESP', copy: 'Spotta fiendeplayerer på Arena och cashout route för bättre rotationsbeslut.' },
