...
export const i18nContent: Record<LocaleCode, { ui: LocaleUi; pages: Record<PageId, PageContent> }> = {
		en: {
			...
			pages: {
				...
				hacks: {
					title: "Rust Cheats 2026 | Undetected ESP Aimbot Guide",
					description: "rust cheats for Windows PC: undetected ESP wallhack, radar hack, and Aimbot with Easy Anti-Cheat maintenance. Compare rust cheats options and buy the full",
					h1: "Rust Cheats — Undetected ESP, Aimbot & Wallhack",
					intro: "rust cheats for raid and farming run combine ESP wallhack visibility, 2D radar-style threat cues, and Aimbot controls in one undetected Windows PC license — maintained after Easy Anti-Cheat patches. This is the pillar guide for rust cheats in 2026.",
					...
					sections: [
						{
							h2: "What rust cheats include in 2026",
							paragraphs: [
								"Players searching for rust cheats usually want visibility and combat tools without stacking separate downloads. Rust Cheats bundles player ESP wallhack, loot markers, 2D radar overlays, and configurable Aimbot in one maintained package — the same toolkit often called rust cheats.",
								"Coverage spans raid and farming run with in-client toggles for live matches. Monthly ($35) and lifetime ($150) licenses unlock the full stack.",
								"Official game updates come from <a href=\"https://store.steampowered.com/app/252490/Rust/\" target=\"_blank\" rel=\"noopener noreferrer\">Rust</a>; our hacks package tracks those releases via the <a href=\"/updates/\">Updates page</a>. Cross-check platform health on <a href=\"https://store.steampowered.com/app/252490/Rust/\" target=\"_blank\" rel=\"noopener noreferrer\">Rust on Steam</a> before patch-day load ins.",
							],
						},
						{
							h2: "How this Rust Cheats pillar fits nearby pages",
							paragraphs: [
								"Use this pillar for the core product overview. For year-specific buying notes, see the <a href=\"/rust-cheats/\">rust cheats 2026</a> and <a href=\"/rust-cheats/\">rust cheats</a> pages cover buyer comparisons in cheats wording.",
								"Deep-dive modules: <a href=\"/rust-esp/\">Rust ESP</a>, <a href=\"/rust-aimbot/\">Rust Aimbot</a>, <a href=\"/rust-esp/\">wallhack</a>, <a href=\"/rust-radar-hack/\">radar hack</a>, and <a href=\"/rust-aimbot/\">soft aim</a>.",
								"Blog guides expand Easy Anti-Cheat keyword: <a href=\"/blog/rust-cheats-complete-guide-2026/\">hacks complete guide</a>, <a href=\"/blog/rust-cheats-buyers-guide/\">cheats buyers guide</a>, and <a href=\"/blog/undetected-rust-cheats-eac/\">undetected Easy Anti-Cheat notes</a>.",
							],
						},
						{
							h2: "rust cheats vs single-feature tools",
							paragraphs: [
								"Standalone hacks often cover only wallhack or only aim assist. Rust Cheats maps the full raid loop: read enemy squads, track enemy players and loot, spot flanks on radar, and tune Aimbot per weapon.",
								...
								"Related landings: <a href=\"/setup/\">cheat download</a>, <a href=\"/rust-cheats/\">mod menu</a>, <a href=\"/rust-aimbot/\">aimbot</a>, <a href=\"/rust-esp/\">ESP</a>.",
							],
						},
						{
							h2: "Undetected rust cheats with Easy Anti-Cheat maintenance",
							paragraphs: [
								"Undetected rust cheats require rebuilds after Easy Anti-Cheat and major Rust patches. Check Updates before loading in — maintenance notes confirm when a new build is live. No package can promise permanent undetected status.",
								"See <a href=\"https://www.easy.ac/\" target=\"_blank\" rel=\"noopener noreferrer\">Easy Anti-Cheat</a> for anti-cheat background and our <a href=\"/updates/\">Easy Anti-Cheat bypass guide</a> for the practical workflow. Pair with <a href=\"/rust-cheats/\">undetected rust cheats</a> for status language buyers expect.",
