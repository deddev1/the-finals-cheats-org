...
> = {
	en: {
		blogTitle: 'Rust Cheats Blog | Raid Guides',
		blogDescription:
			'Rust guides — raid tips, ESP, aimbot notes, loot routes, and Easy Anti-Cheat update coverage. English blog at rustcheats.co/blog/.',
		blogH1: 'Rust Cheats Intel',
		blogIntro:
			'Short Rust guides for base raids and PvP fights. Pair these tips with Rust Cheats product pages when you need ESP, soft aim, or radar.',
		readMore: 'Read guide',
		published: 'Published',
		updated: 'Updated',
	...
	es: {
		...
		blogIntro:
			'Guías SEO de trucos Rust indetectables, ESP wallhack, radar hack, Aimbot y mantenimiento Easy Anti-Cheat en 22 idiomas.',
		readMore: 'Leer guía',
		published: 'Publicado',
		updated: 'Actualizado',
	...
	fr: {
		...
		blogIntro:
			'Guides SEO triches Rust indétectables, ESP wallhack, radar hack, Aimbot et Easy Anti-Cheat en 22 langues.',
	...
	de: {
		...
		blogIntro:
			'SEO-Guides für undetected Rust Cheats, ESP Wallhack, Radar Hack, Aimbot und Easy Anti-Cheat in 22 Sprachen.',
	...
	pt: {
		...
		blogIntro:
			'Guias SEO de cheats Rust indetectáveis, ESP wallhack, radar hack, Aimbot e Easy Anti-Cheat em 22 idiomas.',
		readMore: 'Ler guia',
		published: 'Publicado',
		updated: 'Atualizado',
	...
	it: {
		...
		blogIntro:
			'Guide SEO cheat Rust indetectable, ESP wallhack, radar hack, Aimbot e Easy Anti-Cheat in 22 lingue.',
	...
	nl: {
		...
		blogIntro:
			'SEO-gidsen voor undetected rust cheats, ESP wallhack, radar hack, Aimbot en Easy Anti-Cheat in 22 talen.',
		readMore: 'Lees gids',
	...
	pl: {
		...
		blogIntro:
			'Poradniki SEO undetected cheatów Rust, ESP wallhack, radar hack, Aimbot i Easy Anti-Cheat w 22 językach.',
	...
	ru: {
		...
		blogIntro:
			'SEO-гайды по undetected читам Rust, ESP wallhack, radar hack, Aimbot и Easy Anti-Cheat на 22 языках.',
	...
	tr: {
		...
		blogIntro:
			'Undetected Rust hileleri, ESP wallhack, radar hack, Aimbot ve Easy Anti-Cheat SEO rehberleri 22 dilde.',
	...
	ar: {
		...
		blogIntro:
			'أدلة SEO لغش Rust undetected وESP wallhack ورadar hack وAimbot وEasy Anti-Cheat بـ 22 لغة.',
	...
	ja: {
		...
		blogIntro:
			'undetected Rustチート、ESP wallhack、radar hack、Aimbot、Easy Anti-CheatのSEOガイドを22言語で提供。',
		readMore: 'ガイドを読む',
		published: '公開日',
		updated: '更新日',
	...
	ko: {
		...
		blogIntro:
			'undetected Rust 치트, ESP wallhack, radar hack, Aimbot, Easy Anti-Cheat SEO 가이드를 22개 언어로 제공.',
		readMore: '가이드 읽기',
		published: '게시일',
		updated: '업데이트',
	...
	zh: {
		...
		blogIntro:
			'undetected Rust作弊、ESP wallhack、radar hack、Aimbot和Easy Anti-Cheat的SEO指南，共22种语言。',
		readMore: '阅读指南',
		published: '发布',
		updated: '更新',
	...
	hi: {
		...
		blogIntro:
			'undetected rust cheats, ESP wallhack, radar hack, Aimbot और Easy Anti-Cheat SEO गाइड 22 भाषाओं में।',
		readMore: 'गाइड पढ़ें',
		published: 'प्रकाशित',
		updated: 'अपडेट',
	...
	id: {
		...
		blogIntro:
			'Panduan SEO cheat Rust undetected, ESP wallhack, radar hack, Aimbot dan Easy Anti-Cheat dalam 22 bahasa.',
		readMore: 'Baca panduan',
		published: 'Dipublikasikan',
		updated: 'Diperbarui',
		relatedPosts: 'Pandua Rust terkait',
	...
	th: {
		...
		blogIntro:
			'คู่มือ SEO สำหรับ cheat Rust undetected, ESP wallhack, radar hack, Aimbot และ Easy Anti-Cheat 22 ภาษา',
		readMore: 'อ่านคู่มือ',
		published: 'เผยแพร่',
		updated: 'อัปเดต',
	...
	vi: {
		...
		blogIntro:
			'Hướng dẫn SEO cheat Rust undetected, ESP wallhack, radar hack, Aimbot và Easy Anti-Cheat bằng 22 ngôn ngữ.',
	...
	uk: {
		...
		blogIntro:
			'SEO-гайди з undetected читів Rust, ESP wallhack, radar hack, Aimbot та Easy Anti-Cheat 22 мовами.',
	...
	cs: {
		...
		blogIntro:
			'SEO průvodce undetected rust cheaty, ESP wallhack, radar hack, Aimbot a Easy Anti-Cheat ve 22 jazycích.',
	...
	ro: {
		...
		blogIntro:
			'Ghiduri SEO cheat-uri Rust undetected, ESP wallhack, radar hack, Aimbot și Easy Anti-Cheat în 22 de limbi.',
	...
	sv: {
		...
		blogIntro:
			'SEO-guider för undetected rust cheats, ESP wallhack, radar hack, Aimbot och Easy Anti-Cheat på 22 språk.',
		readMore: 'Läs guide',
