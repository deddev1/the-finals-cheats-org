...
export const brand = {
	...
	seo: {
		...
		previewTitle: 'Rust Cheats | Undetected ESP & Aimbot',
		previewDescription: 'Buy undetected rust cheats for Rust on Windows PC. ESP, soft aim, radar, and Easy Anti-Cheat patch updates in one license with instant delivery.',
