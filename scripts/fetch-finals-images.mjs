...
import { buildOverlaySvg } from './finals-cheat-overlays.mjs';
...
const KEYWORD_ASSETS = [
	{
		file: 'finals-cheats-hero.webp',
		url: `${ME_G}/the-finals-screenshots_wjkx.1400.jpg`,
		overlay: 'hero',
	},
	{
		file: 'finals-cheats-aimbot.webp',
		url: `${ME}/the-finals-screenshots_wjb1.1400.jpg`,
		overlay: 'aimbot',
	},
	{
		file: 'finals-cheats-esp-wallhack.webp',
	...
	{
		file: 'finals-cheats-package.webp',
		url: `${ME}/the-finals-screenshots_anf4.1400.jpg`,
		overlay: 'menu',
	},
	{
		file: 'finals-cheats-cover.webp',
...
async function generateBrandAssets(heroBuffer) {
	...
	await writeFile(path.join(imagesDir, 'finals-cheats-logo.webp'), logoBuffer);
...
for (const asset of KEYWORD_ASSETS) {
	...
	try {
		...
		saved++;
		if (asset.file === 'finals-cheats-hero.webp') heroBuffer = webp;
	} catch (err) {
