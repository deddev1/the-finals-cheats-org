...
export const enPages = {
	...
	hacks: {
		...
		description:
			'rust cheats for Windows PC: undetected ESP wallhack, radar hack, and Aimbot with Easy Anti-Cheat maintenance. Compare rust cheats options and buy the full package.',
		h1: 'Rust Cheats — Undetected ESP, Aimbot & Wallhack',
		intro:
			'rust cheats for raid and farming run combine ESP wallhack visibility, 2D radar-style threat cues, and Aimbot controls in one undetected Windows PC license — maintained after Easy Anti-Cheat patches. This is the pillar guide for rust cheats in 2026.',
		...
		sections: [
			section(
				'What rust cheats include in 2026',
				...
				`Official game updates come from ${EXT.rust}; our hacks package tracks those releases via the <a href="/updates/">Updates page</a>. Cross-check platform health on ${EXT.status} before patch-day load ins.`,
			),
			section(
				'How this Rust Cheats pillar fits nearby pages',
			...
			section(
				'rust cheats vs single-feature tools',
			...
			section(
				'Undetected rust cheats with Easy Anti-Cheat maintenance',
				...
				`See ${EXT.eac} for anti-cheat background and our <a href="/updates/">Easy Anti-Cheat bypass guide</a> for the practical workflow. Pair with <a href="/rust-cheats/">undetected rust cheats</a> for status language buyers expect.`,
