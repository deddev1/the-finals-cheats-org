...
const UI = {
	es: {
		...
		gallery: 'Aspecto en juego', buy: 'Comprar Rust Cheats', viewStore: 'Ver tienda', setupGuide: 'Guía de instalación',
		checkStatus: 'Ver estado', overview: 'Resumen Rust Cheats', viewFeatures: 'Ver funciones', contactSupport: 'Contactar soporte',
		inGame: 'Aspecto en juego', fullGuide: 'Rust Cheats — Guía completa',
	},
	fr: {
		features: 'Fonctions', store: 'Boutique', status: 'Statut', setup: 'Installation', support: 'Support', faq: 'FAQ',
		gallery: 'Rendu en jeu', buy: 'Acheter Rust Cheats', viewStore: 'Voir la boutique', setupGuide: "Guide d'installation",
		checkStatus: 'Voir le statut', overview: 'Aperçu Rust Cheats', viewFeatures: 'Voir les fonctions', contactSupport: 'Contacter le support',
		inGame: 'Rendu en jeu', fullGuide: 'Rust Cheats — Guide complet',
	},
	de: {
		features: 'Features', store: 'Shop', status: 'Status', setup: 'Setup', support: 'Support', faq: 'FAQ',
		gallery: 'Ingame-Ansicht', buy: 'Rust Cheats kaufen', viewStore: 'Shop ansehen', setupGuide: 'Setup-Anleitung',
		checkStatus: 'Status prüfen', overview: 'Rust Cheats Übersicht', viewFeatures: 'Features ansehen', contactSupport: 'Support kontaktieren',
		inGame: 'Ingame-Ansicht', fullGuide: 'Rust Cheats — Vollständiger Guide',
	},
	pt: {
		features: 'Recursos', store: 'Loja', status: 'Status', setup: 'Instalação', support: 'Suporte', faq: 'FAQ',
		gallery: 'Visual in-game', buy: 'Comprar Rust Cheats', viewStore: 'Ver loja', setupGuide: 'Guia de instalação',
		checkStatus: 'Ver status', overview: 'Visão geral Rust Cheats', viewFeatures: 'Ver recursos', contactSupport: 'Contactar suporte',
		inGame: 'Visual in-game', fullGuide: 'Rust Cheats — Guia completo',
	},
	it: {
		features: 'Funzioni', store: 'Negozio', status: 'Stato', setup: 'Setup', support: 'Supporto', faq: 'FAQ',
		gallery: 'Aspetto in-game', buy: 'Acquista Rust Cheats', viewStore: 'Vedi negozio', setupGuide: 'Guida installazione',
		checkStatus: 'Controlla stato', overview: 'Panoramica Rust Cheats', viewFeatures: 'Vedi funzioni', contactSupport: 'Contatta supporto',
		inGame: 'Aspetto in-game', fullGuide: 'Rust Cheats — Guida completa',
	},
	nl: {
		features: 'Functies', store: 'Winkel', status: 'Status', setup: 'Setup', support: 'Support', faq: 'FAQ',
		gallery: 'In-game weergave', buy: 'Rust Cheats kopen', viewStore: 'Winkel bekijken', setupGuide: 'Installatiegids',
		checkStatus: 'Status controleren', overview: 'Rust Cheats overzicht', viewFeatures: 'Functies bekijken', contactSupport: 'Contact support',
		inGame: 'In-game weergave', fullGuide: 'Rust Cheats — Volledige gids',
	},
	pl: {
		features: 'Funkcje', store: 'Sklep', status: 'Status', setup: 'Instalacja', support: 'Wsparcie', faq: 'FAQ',
		gallery: 'Wygląd w grze', buy: 'Kup Rust Cheats', viewStore: 'Zobacz sklep', setupGuide: 'Przewodnik instalacji',
		checkStatus: 'Sprawdź status', overview: 'Przegląd Rust Cheats', viewFeatures: 'Zobacz funkcje', contactSupport: 'Kontakt z supportem',
		inGame: 'Wygląd w grze', fullGuide: 'Rust Cheats — Pełny przewodnik',
	},
	ru: {
		features: 'Функции', store: 'Магазин', status: 'Статус', setup: 'Установка', support: 'Поддержка', faq: 'FAQ',
		gallery: 'Вид в игре', buy: 'Купить Rust Cheats', viewStore: 'Открыть магазин', setupGuide: 'Гайд по установке',
		checkStatus: 'Проверить статус', overview: 'Обзор Rust Cheats', viewFeatures: 'Смотреть функции', contactSupport: 'Связаться с поддержкой',
		inGame: 'Вид в игре', fullGuide: 'Rust Cheats — Полный гайд',
	},
	tr: {
		features: 'Özellikler', store: 'Mağaza', status: 'Durum', setup: 'Kurulum', support: 'Destek', faq: 'SSS',
		gallery: 'Oyun içi görünüm', buy: 'Rust Cheats satın al', viewStore: 'Mağazayı gör', setupGuide: 'Kurulum rehberi',
		checkStatus: 'Durumu kontrol et', overview: 'Rust Cheats genel bakış', viewFeatures: 'Özellikleri gör', contactSupport: 'Destekle iletişim',
		inGame: 'Oyun içi görünüm', fullGuide: 'Rust Cheats — Tam rehber',
	},
	ar: {
		features: 'الميزات', store: 'المتجر', status: 'الحالة', setup: 'التثبيت', support: 'الدعم', faq: 'الأسئلة الشائعة',
		gallery: 'المظهر داخل اللعبة', buy: 'اشترِ Rust Cheats', viewStore: 'عرض المتجر', setupGuide: 'دليل التثبيت',
		checkStatus: 'تحقق من الحالة', overview: 'نظرة عامة على Rust Cheats', viewFeatures: 'عرض الميزات', contactSupport: 'اتصل بالدعم',
		inGame: 'المظهر داخل اللعبة', fullGuide: 'Rust Cheats — دليل كامل',
	},
	ja: {
		features: '機能', store: 'ストア', status: 'ステータス', setup: 'セットアップ', support: 'サポート', faq: 'FAQ',
		gallery: 'ゲーム内の見た目', buy: 'Rust Cheatsを購入', viewStore: 'ストアを見る', setupGuide: 'セットアップガイド',
		checkStatus: 'ステータスを確認', overview: 'Rust Cheats概要', viewFeatures: '機能を見る', contactSupport: 'サポートに連絡',
		inGame: 'ゲーム内の見た目', fullGuide: 'Rust Cheats — 完全ガイド',
	},
	ko: {
		features: '기능', store: '스토어', status: '상태', setup: '설치', support: '지원', faq: 'FAQ',
		gallery: '인게임 화면', buy: 'Rust Cheats 구매', viewStore: '스토어 보기', setupGuide: '설치 가이드',
		checkStatus: '상태 확인', overview: 'Rust Cheats 개요', viewFeatures: '기능 보기', contactSupport: '지원 문의',
		inGame: '인게임 화면', fullGuide: 'Rust Cheats — 전체 가이드',
	},
	zh: {
		features: '功能', store: '商店', status: '状态', setup: '安装', support: '支持', faq: '常见问题',
		gallery: '游戏内效果', buy: '购买 Rust Cheats', viewStore: '查看商店', setupGuide: '安装指南',
		checkStatus: '查看状态', overview: 'Rust Cheats概览', viewFeatures: '查看功能', contactSupport: '联系支持',
		inGame: '游戏内效果', fullGuide: 'Rust Cheats — 完整指南',
	},
	hi: {
		features: 'फ़ीचर्स', store: 'स्टोर', status: 'स्टेटस', setup: 'सेटअप', support: 'सहायता', faq: 'FAQ',
		gallery: 'इन-गेम लुक', buy: 'Rust Cheats खरीदें', viewStore: 'स्टोर देखें', setupGuide: 'सेटअप गाइड',
		checkStatus: 'स्टेटस जांचें', overview: 'Rust Cheats अवलोकन', viewFeatures: 'फ़ीचर्स देखें', contactSupport: 'सहायता से संपर्क',
		inGame: 'इन-गेम लुक', fullGuide: 'Rust Cheats — पूर्ण गाइड',
	},
	id: {
		features: 'Fitur', store: 'Toko', status: 'Status', setup: 'Setup', support: 'Dukungan', faq: 'FAQ',
		gallery: 'Tampilan in-game', buy: 'Beli Rust Cheats', viewStore: 'Lihat toko', setupGuide: 'Panduan setup',
		checkStatus: 'Cek status', overview: 'Ringkasan Rust Cheats', viewFeatures: 'Lihat fitur', contactSupport: 'Hubungi dukungan',
		inGame: 'Tampilan in-game', fullGuide: 'Rust Cheats — Panduan lengkap',
	},
	th: {
		features: 'ฟีเจอร์', store: 'ร้านค้า', status: 'สถานะ', setup: 'ติดตั้ง', support: 'สนับสนุน', faq: 'FAQ',
		gallery: 'ลุคในเกม', buy: 'ซื้อ Rust Cheats', viewStore: 'ดูร้านค้า', setupGuide: 'คู่มือติดตั้ง',
		checkStatus: 'ตรวจสอบสถานะ', overview: 'ภาพรวม Rust Cheats', viewFeatures: 'ดูฟีเจอร์', contactSupport: 'ติดต่อฝ่ายสนับสนุน',
		inGame: 'ลุคในเกม', fullGuide: 'Rust Cheats — คู่มือฉบับสมบูรณ์',
	},
	vi: {
		features: 'Tính năng', store: 'Cửa hàng', status: 'Trạng thái', setup: 'Cài đặt', support: 'Hỗ trợ', faq: 'FAQ',
		gallery: 'Giao diện trong game', buy: 'Mua Rust Cheats', viewStore: 'Xem cửa hàng', setupGuide: 'Hướng dẫn cài đặt',
		checkStatus: 'Kiểm tra trạng thái', overview: 'Tổng quan Rust Cheats', viewFeatures: 'Xem tính năng', contactSupport: 'Liên hệ hỗ trợ',
		inGame: 'Giao diện trong game', fullGuide: 'Rust Cheats — Hướng dẫn đầy đủ',
	},
	uk: {
		features: 'Функції', store: 'Магазин', status: 'Статус', setup: 'Встановлення', support: 'Підтримка', faq: 'FAQ',
		gallery: 'Вигляд у грі', buy: 'Купити Rust Cheats', viewStore: 'Переглянути магазин', setupGuide: 'Гайд з встановлення',
		checkStatus: 'Перевірити статус', overview: 'Огляд Rust Cheats', viewFeatures: 'Дивитися функції', contactSupport: "Зв'язатися з підтримкою",
		inGame: 'Вигляд у грі', fullGuide: 'Rust Cheats — Повний гайд',
	},
	cs: {
		features: 'Funkce', store: 'Obchod', status: 'Stav', setup: 'Instalace', support: 'Podpora', faq: 'FAQ',
		gallery: 'Vzhled ve hře', buy: 'Koupit Rust Cheats', viewStore: 'Zobrazit obchod', setupGuide: 'Průvodce instalací',
		checkStatus: 'Zkontrolovat stav', overview: 'Přehled Rust Cheats', viewFeatures: 'Zobrazit funkce', contactSupport: 'Kontaktovat podporu',
		inGame: 'Vzhled ve hře', fullGuide: 'Rust Cheats — Kompletní průvodce',
	},
	ro: {
		features: 'Funcții', store: 'Magazin', status: 'Status', setup: 'Instalare', support: 'Suport', faq: 'FAQ',
		gallery: 'Aspect în joc', buy: 'Cumpără Rust Cheats', viewStore: 'Vezi magazinul', setupGuide: 'Ghid de instalare',
		checkStatus: 'Verifică statusul', overview: 'Prezentare Rust Cheats', viewFeatures: 'Vezi funcțiile', contactSupport: 'Contactează suportul',
		inGame: 'Aspect în joc', fullGuide: 'Rust Cheats — Ghid complet',
	},
	sv: {
		features: 'Funktioner', store: 'Butik', status: 'Status', setup: 'Installation', support: 'Support', faq: 'FAQ',
		gallery: 'Utseende i spelet', buy: 'Köp Rust Cheats', viewStore: 'Visa butik', setupGuide: 'Installationsguide',
		checkStatus: 'Kontrollera status', overview: 'Rust Cheats-översikt', viewFeatures: 'Visa funktioner', contactSupport: 'Kontakta support',
		inGame: 'Utseende i spelet', fullGuide: 'Rust Cheats — Fullständig guide',
	},
};
...
function buildFeatures(locale, u, p) {
	...
	const t = {
		es: {
			...
			p: [
				...
				['Asistencia de puntería que puedes ajustar para que se sienta natural.', 'Configura FOV, suavidad y prioridad de huesos por arma antes del raid.'],
				['Un radar 2D simple para amenazas fuera de tu vista.', 'Detecta flancos cerca de monumentos sin llenar toda la pantalla.'],
				['La mayoría de sitios de trucos cubren ESP, aimbot, radar, instalación y estado en páginas separadas. Usa estas guías:', 'Cada guía cubre una parte del stack de raid para que compares antes del checkout.'],
				['Reconstruimos tras parches grandes de Rust o Easy Anti-Cheat.', 'Revisa Estado antes de jugar después de un día de parche.', 'Verifica cambios oficiales en las notas de Steam y la Wiki de Rust antes de ajustar overlays.'],
			],
			list: [
				...
				['Señales de enemigos cercanos', 'Rango ajustable', 'Funciona en raids y roaming'],
				null,
		...
		fr: {
			...
			p: [
				...
				['Aide à la visée réglable pour un rendu naturel.', 'Définissez FOV, fluidité et priorité d\'os par arme avant le raid.'],
				['Un radar 2D simple pour les menaces hors champ.', 'Repérez les flancs près des monuments sans remplir l\'écran.'],
				['La plupart des sites couvrent ESP, aimbot, radar, installation et statut sur des pages séparées. Utilisez ces guides :', 'Chaque guide couvre une partie du stack de raid pour comparer avant le checkout.'],
				['Nous reconstruisons après les gros patchs Rust ou Easy Anti-Cheat.', 'Consultez Statut avant de jouer après un jour de patch.', 'Vérifiez les notes Steam et le Wiki Rust avant d\'ajuster les overlays.'],
			],
			list: [
				...
				['Indices d\'ennemis proches', 'Portée réglable', 'Fonctionne en raids et roaming'],
				null,
		...
		de: {
			...
			p: [
				...
				['Wir bauen nach großen Rust- oder Easy Anti-Cheat-Patches neu.', 'Prüfe Status vor dem Spielen nach Patch-Tagen.', 'Offizielle Änderungen in Steam-Patchnotes und Rust Wiki prüfen, bevor du Overlays anpasst.'],
			],
			list: [
	...
	if (!content) {
		return {
			title: `${u.features} 2026 | ESP, Aimbot & Radar | Rust Cheats`,
			description: p.s1(focus).slice(0, 160),
			h1: u.features,
			intro: p.s1(`${u.features} für Rust auf ${p.win}.`),
			ctaPrimary: u.buy,
...
export function buildSimplePagesForLocale(locale) {
	...
	for (const [pageId, enPage] of Object.entries(simplePagesEn)) {
		...
		const h1Map = {
			...
			'rust-esp': 'ESP', 'rust-aimbot': 'Aimbot', radar: 'Radar', setup: u.setup,
			support: u.support, faq: u.faq,
		};
		pages[pageId] = {
			...enPage,
			title: enPage.title.replace(/^[^|]+/, h1Map[pageId] ?? enPage.h1).replace('Rust Cheats', 'Rust Cheats'),
...
function getNativeSimpleContent(locale, u, p) {
	...
	mk('rust-esp', {
		h1: 'ESP',
		intro: sectionParas(L, 'rust-esp', 'intro', p)[0],
		sections: [
			{ h2: sectionTitle(L, 'whatEspShows'), paragraphs: sectionParas(L, 'rust-esp', 0, p), list: sectionList(L, 'rust-esp', 0) },
			{ h2: sectionTitle(L, 'whenToUse'), paragraphs: sectionParas(L, 'rust-esp', 1, p), list: sectionList(L, 'rust-esp', 1) },
			{ h2: sectionTitle(L, 'nextSteps'), paragraphs: sectionParas(L, 'rust-esp', 2, p), list: sectionList(L, 'rust-esp', 2, L) },
		],
	});

	mk('rust-aimbot', {
		h1: 'Aimbot',
		intro: sectionParas(L, 'rust-aimbot', 'intro', p)[0],
		sections: [
			{ h2: sectionTitle(L, 'controls'), paragraphs: sectionParas(L, 'rust-aimbot', 0, p), list: sectionList(L, 'rust-aimbot', 0) },
			{ h2: sectionTitle(L, 'playStyles'), paragraphs: sectionParas(L, 'rust-aimbot', 1, p), list: sectionList(L, 'rust-aimbot', 1) },
			{ h2: sectionTitle(L, 'nextSteps'), paragraphs: sectionParas(L, 'rust-aimbot', 2, p), list: sectionList(L, 'rust-aimbot', 2, L) },
		],
	});
...
const SECTION_TITLES = {
	...
	whatAreCheats: { es: '¿Qué son los trucos de Rust?', fr: 'Que sont les triches Rust ?', de: 'Was sind Rust Cheats?', pt: 'O que são cheats de Rust?', it: 'Cosa sono i cheat Rust?', nl: 'Wat zijn Rust cheats?', pl: 'Czym są cheaty Rust?', ru: 'Что такое читы Rust?', tr: 'Rust hileleri nedir?', ar: 'ما هي غش Rust؟', ja: 'Rustチートとは？', ko: 'Rust 치트란?', zh: '什么是Rust作弊？', hi: 'Rust cheats क्या हैं?', id: 'Apa itu cheat Rust?', th: 'Rust cheats คืออะไร?', vi: 'Cheat Rust là gì?', uk: 'Що таке чіти Rust?', cs: 'Co jsou rust cheaty?', ro: 'Ce sunt cheats Rust?', sv: 'Vad är Rust cheats?' },
	whatIncludes: { es: 'Qué incluye Rust Cheats', fr: 'Ce que Rust Cheats inclut', de: 'Was Rust Cheats enthält', pt: 'O que o Rust Cheats inclui', it: 'Cosa include Rust Cheats', nl: 'Wat Rust Cheats bevat', pl: 'Co zawiera Rust Cheats', ru: 'Что входит в Rust Cheats', tr: 'Rust Cheats neleri içerir', ar: 'ماذا يتضمن Rust Cheats', ja: 'Rust Cheatsの内容', ko: 'Rust Cheats 포함 사항', zh: 'Rust Cheats包含什么', hi: 'Rust Cheats में क्या शामिल है', id: 'Apa yang termasuk Rust Cheats', th: 'Rust Cheats รวมอะไรบ้าง', vi: 'Rust Cheats bao gồm gì', uk: 'Що входить до Rust Cheats', cs: 'Co obsahuje Rust Cheats', ro: 'Ce include Rust Cheats', sv: 'Vad Rust Cheats innehåller' },
