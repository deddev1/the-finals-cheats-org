...
const HOME_CONNECTORS = {
	es: {
		...
		aboutPillar: 'pilar de trucos de Rust',
	...
	fr: {
		...
		aboutPillar: 'pilier Rust Cheats',
		aboutEsp: 'guide ESP',
	...
	de: {
		...
		aboutPillar: 'Rust Cheats Leitfaden',
		aboutEsp: 'ESP-Guide',
	...
	it: {
		...
		aboutPillar: 'pilastro Rust Cheats',
		aboutEsp: 'guida ESP',
	...
	nl: {
		...
		aboutPillar: 'Rust Cheats-pijler',
		aboutEsp: 'ESP-gids',
	...
	pl: {
		...
		aboutPillar: 'filaru Rust Cheats',
	...
	ru: {
		...
		aboutPillar: 'путеводителя Rust Cheats',
		aboutEsp: 'гайда ESP',
	...
	tr: {
		...
		aboutP2Before: 'Önce',
		aboutPillar: 'Rust Cheats rehberi',
	...
	th: {
		...
		aboutPillar: 'คู่มือ Rust Cheats',
		aboutEsp: 'คู่มือ ESP',
	...
	vi: {
		...
		aboutPillar: 'trụ cột Rust Cheats',
	...
	uk: {
		...
		aboutPillar: 'путівника Rust Cheats',
		aboutEsp: 'гайду ESP',
	...
	cs: {
		...
		aboutPillar: 'průvodcem Rust Cheats',
	...
	ro: {
		...
		aboutPillar: 'ghidul Rust Cheats',
		aboutEsp: 'ghidul ESP',
	...
	sv: {
		...
		aboutPillar: 'Rust Cheats-guiden',
		aboutEsp: 'ESP-guiden',
...
function buildHomeSeo(ui, locale) {
	...
	const labels = {
		es: {
			...
			linkPlans: 'Planes', linkReviews: n.reviews ?? 'Reseñas', linkRustCheats: 'Trucos de Rust',
		...
		fr: {
			...
			linkPlans: 'Formules', linkReviews: 'Avis', linkRustCheats: 'Triches Rust',
		...
		de: {
			...
			linkPlans: 'Pläne', linkReviews: 'Bewertungen', linkRustCheats: 'Rust Cheats',
	...
	const l = labels[locale] ?? {
		...
		linkRustCheats: ui.product.title,
	...
	return {
		...
		linkRustCheats: l.linkRustCheats,
		linkFaq: n.faq,
		linkSupport: 'Support',
...
function buildExternalResources(locale) {
	const labels = {
		es: {
			...
			steam: 'Rust en Steam', steamNote: 'Página oficial de la tienda, requisitos y reseñas.',
			patch: 'Parches y noticias de Steam', patchNote: 'Lee actualizaciones oficiales antes de cambiar tu loadout.',
			official: 'Sitio oficial de Rust', officialNote: 'Resumen del juego de Facepunch Studios.',
			wiki: 'Wiki de Rust (Fandom)', wikiNote: 'Estadísticas, mapas y mecánicas de supervivencia.',
		...
		fr: {
			...
			steam: 'Rust sur Steam', steamNote: 'Page officielle, configuration requise et avis.',
			patch: 'Notes de patch Steam', patchNote: 'Lisez les mises à jour officielles avant de changer votre loadout.',
			official: 'Site officiel Rust', officialNote: 'Présentation du jeu par Facepunch Studios.',
			wiki: 'Wiki Rust (Fandom)', wikiNote: 'Stats joueurs, cartes et mécaniques de survie.',
		...
		de: {
			...
			steam: 'Rust auf Steam', steamNote: 'Offizielle Store-Seite, Systemanforderungen und Bewertungen.',
			patch: 'Steam Patchnotes & News', patchNote: 'Offizielle Updates lesen, bevor du dein Loadout änderst.',
			official: 'Offizielle Rust-Website', officialNote: 'Spielübersicht von Facepunch Studios.',
			wiki: 'Rust Wiki (Fandom)', wikiNote: 'Spielerstatistiken, Karten und Survival-Mechaniken.',
