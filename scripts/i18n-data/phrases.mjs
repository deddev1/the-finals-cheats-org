...
export const phrases = {
	es: {
		buy: 'Comprar Rust Cheats', undetected: 'indetectables', maps: 'Outpost, monuments, and compound zones',
		...
		legal: () => 'Contacta support@rustcheats.co para solicitudes legales o de soporte.',
	},
	fr: {
		buy: 'Acheter Rust Cheats', undetected: 'indétectables', maps: 'Outpost, monuments, and compound zones',
		...
		legal: () => 'Contactez support@rustcheats.co pour le support ou les demandes légales.',
	},
	de: {
		buy: 'Rust Cheats kaufen', undetected: 'undetected', maps: 'Outpost, monuments, and compound zones',
		...
		legal: () => 'support@rustcheats.co für Support und rechtliche Anfragen.',
	},
	pt: {
		buy: 'Comprar Rust Cheats', undetected: 'indetectáveis', maps: 'Outpost, monuments, and compound zones',
		...
		legal: () => 'Contacte support@rustcheats.co para suporte ou questões legais.',
	},
	it: {
		buy: 'Acquista Rust Cheats', undetected: 'indetectable', maps: 'Outpost, monuments, and compound zones',
		...
		legal: () => 'Contatta support@rustcheats.co per supporto o richieste legali.',
	},
	nl: {
		buy: 'Rust Cheats kopen', undetected: 'undetected', maps: 'Outpost, monuments, and compound zones',
		...
		legal: () => 'support@rustcheats.co voor support en juridische vragen.',
	},
	pl: {
		buy: 'Kup Rust Cheats', undetected: 'undetected', maps: 'Outpost, monuments, and compound zones',
		...
		legal: () => 'support@rustcheats.co w sprawach wsparcia i prawnych.',
	},
	ru: {
		buy: 'Купить Rust Cheats', undetected: 'undetected', maps: 'Outpost, monuments, and compound zones',
		...
		legal: () => 'support@rustcheats.co для поддержки и юридических вопросов.',
	},
	tr: {
		buy: 'Rust Cheats satın al', undetected: 'undetected', maps: 'Outpost, monuments, and compound zones',
		...
		legal: () => 'Destek ve yasal sorular için support@rustcheats.co.',
	},
	ar: {
		buy: 'اشترِ Rust Cheats', undetected: 'غير مكتشف', maps: 'Outpost, monuments, and compound zones',
		...
		legal: () => 'support@rustcheats.co للدعم والطلبات القانونية.',
	},
	ja: {
		buy: 'Rust Cheatsを購入', undetected: 'undetected', maps: 'Outpost, monuments, and compound zones',
		...
		legal: () => 'サポート・法務: support@rustcheats.co',
	},
	ko: {
		buy: 'Rust Cheats 구매', undetected: 'undetected', maps: 'Outpost, monuments, and compound zones',
		...
		legal: () => '지원 및 법무: support@rustcheats.co',
	},
	zh: {
		buy: '购买 Rust Cheats', undetected: 'undetected', maps: 'Outpost, monuments, and compound zones',
		...
		legal: () => '支持与法务：support@rustcheats.co',
	},
	hi: {
		buy: 'Rust Cheats खरीदें', undetected: 'undetected', maps: 'Outpost, monuments, and compound zones',
		...
		legal: () => 'सहायता: support@rustcheats.co',
	},
	id: {
		buy: 'Beli Rust Cheats', undetected: 'undetected', maps: 'Outpost, monuments, and compound zones',
		...
		legal: () => 'support@rustcheats.co untuk dukungan dan legal.',
	},
	th: {
		buy: 'ซื้อ Rust Cheats', undetected: 'undetected', maps: 'Outpost, monuments, and compound zones',
		...
		legal: () => 'support@rustcheats.co สำหรับการสนับสนุน',
	},
	vi: {
		buy: 'Mua Rust Cheats', undetected: 'undetected', maps: 'Outpost, monuments, and compound zones',
		...
		legal: () => 'support@rustcheats.co cho hỗ trợ và pháp lý.',
	},
	uk: {
		buy: 'Купити Rust Cheats', undetected: 'undetected', maps: 'Outpost, monuments, and compound zones',
		...
		legal: () => 'support@rustcheats.co для підтримки та правових питань.',
	},
	cs: {
		buy: 'Koupit Rust Cheats', undetected: 'undetected', maps: 'Outpost, monuments, and compound zones',
		...
		legal: () => 'support@rustcheats.co pro podporu a právní dotazy.',
	},
	ro: {
		buy: 'Cumpără Rust Cheats', undetected: 'undetected', maps: 'Outpost, monuments, and compound zones',
		...
		legal: () => 'support@rustcheats.co pentru suport și legal.',
	},
	sv: {
		buy: 'Köp Rust Cheats', undetected: 'undetected', maps: 'Outpost, monuments, and compound zones',
		...
		legal: () => 'support@rustcheats.co för support och juridik.',
	},
};
