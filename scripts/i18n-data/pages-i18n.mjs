...
export const PAGE_META_HOME = {
	...
	ja: { title: 'The Final Cheats 2026 | ESP・Wallhack・Aimbot', desc: 'The Finals向けundetectedチート。ESP wallhack、radar hack、Aimbot、Easy Anti-Cheatメンテナンス。即時デジタル配信。', h1: 'The Final Cheats — Undetected ESP・Wallhack・Aimbot', intro: 'The Finals Windows PC向けundetectedパッケージ：ESP wallhack、radar、Aimbot、Easy Anti-Cheatメンテナンス付き。', imageAlt: 'the finals cheats hero ESP aimbot wallhack', gallery: 'The Final Cheatsギャラリー — ESP、Aimbot、wallhack', cta2: '機能を見る', h2a: '2026年にThe Final Cheatsを選ぶ理由', h2b: 'ESP wallhack、radar、Aimbotが1ライセンス', topicA: 'BRとfarming runで敵スクワッドを読むのに最適。', topicB: '別ツールではなく1ライセンス。' },
	ko: { title: 'The Final Cheats 2026 | ESP, Wallhack, Aimbot', desc: 'The Finals undetected 치트. ESP wallhack, radar hack, Aimbot, Easy Anti-Cheat 유지보수. 즉시 디지털 배송.', h1: 'The Final Cheats — Undetected ESP, Wallhack, Aimbot', intro: 'The Finals Windows PC undetected 패키지: ESP wallhack, radar, Aimbot, Easy Anti-Cheat 유지보수 포함.', imageAlt: 'the finals cheats hero ESP aimbot wallhack', gallery: 'The Final Cheats 갤러리 — ESP, Aimbot, wallhack', cta2: '기능 보기', h2a: '2026년 The Final Cheats를 선택하는 이유', h2b: 'ESP wallhack, radar, Aimbot 단일 라이선스', topicA: 'BR 및 farming run에서 적 분대 읽기에 이상적.', topicB: '별도 도구 대신 단일 라이선스.' },
	zh: { title: 'The Final Cheats 2026 | ESP、Wallhack、Aimbot', desc: 'The Finals undetected作弊。ESP wallhack、radar hack、Aimbot、Easy Anti-Cheat维护。即时数字交付。', h1: 'The Final Cheats — Undetected ESP、Wallhack、Aimbot', intro: 'The Finals Windows PC undetected套餐：ESP wallhack、radar、Aimbot，含Easy Anti-Cheat维护。', imageAlt: 'the finals cheats hero ESP aimbot wallhack', gallery: 'The Final Cheats图库 — ESP、Aimbot、wallhack', cta2: '查看功能', h2a: '2026年选择The Final Cheats的原因', h2b: 'ESP wallhack、radar、Aimbot单一许可证', topicA: '适合在BR和farming run中读取敌方小队。', topicB: '一个许可证而非多个工具。' },
	hi: { title: 'The Final Cheats 2026 | ESP, Wallhack और Aimbot', desc: 'The Finals undetected cheats. ESP wallhack, radar hack, Aimbot, Easy Anti-Cheat maintenance. Instant digital delivery.', h1: 'The Final Cheats — Undetected ESP, Wallhack और Aimbot', intro: 'The Finals Windows PC undetected पैकेज: ESP wallhack, radar, Aimbot, Easy Anti-Cheat maintenance सहित.', imageAlt: 'the finals cheats hero ESP aimbot wallhack', gallery: 'The Final Cheats gallery — ESP, Aimbot, wallhack', cta2: 'फ़ीचर्स देखें', h2a: '2026 में The Final Cheats क्यों', h2b: 'ESP wallhack, radar, Aimbot एक लाइसेंस में', topicA: 'BR और farming run में दुश्मन pack पढ़ने के लिए आदर्श.', topicB: 'अलग टूल्स के बजाय एक लाइसेंस.' },
...
const PAGE_META_TAILS = {
	...
	'cheats-2026': { suffix: 'Buyer Guide', focus: '2026 the finals cheats checklist before checkout', altKeyword: 'cheats 2026 ESP aimbot' },
	...
	'best-cheats': { suffix: 'Buyer Checklist', focus: 'what to compare before buying the finals cheats', altKeyword: 'best cheats ESP aimbot' },
...
export const TOPIC_NAMES = {
	...
	'best-cheats': { en: 'Best The Final Cheats', es: 'Mejores trucos The Finals', fr: 'Meilleures triches The Finals', de: 'Beste The Final Cheats', pt: 'Melhores cheats The Finals', it: 'Migliori cheat The Finals', nl: 'Beste The Final Cheats', pl: 'Najlepsze cheaty The Finals', ru: 'Лучшие читы The Finals', tr: 'En İyi The Finals Hileleri', ar: 'أفضل غش The Finals', ja: '最強The Finalsチート', ko: '최고의 The Finals 치트', zh: '最佳The Finals作弊', hi: 'सर्वश्रेष्ठ The Final Cheats', id: 'Cheat The Finals terbaik', th: 'Cheat The Finals ที่ดีที่สุด', vi: 'Cheat The Finals tốt nhất', uk: 'Найкращі чіти The Finals', cs: 'Nejlepší the finals cheaty', ro: 'Cele mai bune cheats The Finals', sv: 'Bästa The Final Cheats' },
